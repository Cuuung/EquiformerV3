#!/usr/bin/env bash
# N2L2C64 direct 15ep, 自建 enable_compile(+compile_dynamic) + fp16(--amp) + tf32(yml). 单阶段。
set -euo pipefail
...
CFG='experimental/configs/omat24/mptrj/experiments/direct/compile_test/enable-compile_fp16_tf32.yml'
RUN_DIR='/mnt/afs/share/checkpoint/equiformerV3/maoruicong'   # EDIT: 输出目录
ID='N2L2C64_direct_encompile_fp16_tf32'
