#!/usr/bin/env bash
# N2L2C64 direct 15ep, 外层 use_compile + 纯 fp32 (无 amp/tf32/bf16). 单阶段。
set -euo pipefail
...
CFG='experimental/configs/omat24/mptrj/experiments/direct/compile_test/compile_fp32.yml'
RUN_DIR='/mnt/afs/share/checkpoint/equiformerV3/maoruicong'   # EDIT: 输出目录
ID='N2L2C64_direct_compile'
